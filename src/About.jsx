...
const styles = `
  ...
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  /* NAV — identical to Equipment.jsx / App.jsx */
  .nav {
  ...
  .card-title {
    font-family: 'Bebas Neue', cursive;
    font-size: 28px; letter-spacing: 1px; color: var(--white); margin-bottom: 12px;
  }
...
export default function About() {
  ...
  const titleWords = content.about.title.split(' ')
  ...
  return (
    <>
      ...
      {/* NAV — exact same markup as Equipment.jsx */}
      <nav className="nav">
      ...
      <div className="page-header">
        <h1>{titleFirst} <span>{titleRest}</span></h1>
      ...
      <section className="section" style={{ background: 'var(--darker)' }}>
        ...
        <div className="grid-3">
          {[
            { icon: '🎯', title: 'Our Mission', desc: content.about.mission },
            { icon: '👁️', title: 'Our Vision',  desc: content.about.vision  },
            { icon: '💪', title: 'Our Values',  desc: content.about.values  },
          ].map((item, i) => (
