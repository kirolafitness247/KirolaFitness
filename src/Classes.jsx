  ...
  return (
    <>
      ...
      <div className="page-header">
        <h1>{content.classesPage.title.split(' ')[0]} <span>{content.classesPage.title.split(' ').slice(1).join(' ')}</span></h1>
        ...
        <div className="grid-3">
          {content.classesPage.classList.map((cls, i) => (
            <div key={i} className="card">
              ...
              <div style={{fontSize:'13px',color:'var(--muted)',marginBottom:'8px'}}>⏰ {cls.time}</div>
              <div style={{fontSize:'13px',color:'var(--muted)',marginBottom:'8px'}}>👤 {cls.trainer}</div>
              <div style={{fontSize:'13px',color:'var(--muted)',marginBottom:'8px'}}>📊 {cls.level}</div>
              <div style={{fontSize:'14px',color:'var(--gold)',marginBottom:'20px',fontWeight:'600'}}>🎟️ {cls.spots} spots available</div>
